...
writer = SummaryWriter("./tb_record_1_1")
...
def train(lr=0.01, gamma=0.99):
    ...
    for i_episode in count(1):
        ...
        writer.add_scalar('LearningRate', lr, i_episode)
        ...
        if ewma_reward > env.spec.reward_threshold:
            if not os.path.isdir("./preTrained"):
                os.mkdir("./preTrained")
            torch.save(model.state_dict(), './preTrained/CartPole_lr{}_gamma{}_1.pth'.format(lr, gamma))
...
if __name__ == '__main__':
    ...
    train(lr, gamma)
    test(f'CartPole_lr{lr}_gamma{gamma}_1.pth')
